document.addEventListener('DOMContentLoaded', function () {
  ...
  const text_314 = document.getElementById('text_314');
  const text_315 = document.getElementById('text_315');
  const text_316 = document.getElementById('text_316');
  const text_317 = document.getElementById('text_317');
  const text_320 = document.getElementById('text_320');
  const text_321 = document.getElementById('text_321');
  ...
  function loadTranslation(lang) {
    fetch(`/locales/${lang}.json`)
      ...
      .then(translations => {
        ...
        text_314.textContent = translations.text_314;
        text_315.textContent = translations.text_315;
        text_316.textContent = translations.text_316;
        text_317.textContent = translations.text_317;
        text_320.textContent = translations.text_320;
        text_321.textContent = translations.text_321;
